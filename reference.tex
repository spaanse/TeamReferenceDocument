...
\begin{document}
	\begin{multicols*}{2}
		...
		\begin{multicols}{2}
			\subsection{Treap}
			\inputminted[firstline=16,lastline=69]{c++}{_code/datastructures/treap.cpp}
			\columnbreak
			\inputminted[firstline=70,lastline=109]{c++}{_code/datastructures/treap.cpp}
			% \subsection{AVL Tree}
			% \inputminted[firstline=7,lastline=59]{c++}{_code/datastructures/avl_tree.cpp}
			% \columnbreak
			% \inputminted[firstline=60,lastline=113]{c++}{_code/datastructures/avl_tree.cpp}
			\vfill\null
		\end{multicols}
		\newpage
	\end{multicols*}
